	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, [(0, _h2.default)('header', [this.name]), (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.btn.btn-default.btn-xs.btn-mute.btn-primary' + muteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
	      }, ['Mute']),
          (0, _h2.default)('span.btn.btn-default.btn-xs.btn-solo.btn-warning' + soloClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('solo', _this2);
	        }
	      }, ['Solo']),
          (0, _h2.default)('span.btn.btn-default.btn-xs.btn-deletetrack.btn-danger' + soloClass, {
	        onclick: function onclick() {
